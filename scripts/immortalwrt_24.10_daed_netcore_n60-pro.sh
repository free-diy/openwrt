...
# 1. 修改默认 IP
sed -i 's/192\.168\.110\.1/10.31.2.251/g' package/base-files/files/bin/config_generate
sed -i 's/192\.168\.6\.1/10.31.2.251/g' package/base-files/files/bin/config_generate
